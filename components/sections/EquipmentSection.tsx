...
// Имена файлов для каждого комплекта — kit-0.jpg ... kit-4.jpg
// Положите их в public/images/ и они появятся автоматически
const KIT_IMAGES = [
  "/images/kit-0.jpg",
  "/images/kit-1.jpg",
  "/images/kit-2.jpg",
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {EQUIPMENT.kits.map((kit, i) => (
            ...
            >
              ...
              <KitImage index={i} tag={kit.tag} />

              <p className={`mono-tag mb-1 ${kit.featured ? "text-accent" : "text-text-muted"}`}>
                {kit.tag}
              </p>
              ...
              <ul className="flex flex-col gap-2 flex-1 mb-5">
                {kit.items.map((item, ii) => (
                  <li key={ii} className="flex items-start gap-2 text-xs text-text-secondary leading-snug">
